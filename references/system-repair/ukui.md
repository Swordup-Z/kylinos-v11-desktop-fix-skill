...
| 锁屏超时 | 设置界面中的锁屏/关屏时间不生效，或电源设置与实际锁屏时间不一致 | `knowledge/system-repair/ukui/screen-lock-delay.md` |
...
| 系统截图 | 点击截图后冻结画面变暗/变糊，或最终截图清晰度异常 | `knowledge/system-repair/ukui/screenshot.md` |
