...
- 仅在用户问题明确涉及 KylinOS Desktop V11、UKUI、KARE/Kaiming、系统服务、TUN、开机自启动、维护模式、磐石架构、分区挂载、overlay、AI 子系统等桌面系统维护场景时使用本 skill；普通代码开发、文档编辑、Git 操作或与桌面系统无关的问题不应加载本 skill。
